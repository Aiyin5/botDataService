...
exports.captcha =async (req, res) => {
    ...
    try {
        ...
        if(dataRes.length > 0 && register===1){
            ...
            const sendMailobj = {
                html: `<div><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:60px 0;text-align:center;"><div class="mj-column-per-100_kzFl mj-outlook-group-fix_BZpA" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tbody><tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;"><tbody><tr><td style="width:150;padding-bottom: 30px;"><div height="auto" style="border:0;display:block;outline:none;text-decoration:none;height:32px;width:168px;font-size:13px;"><img  width="auto" height="80" src="https://aiyinchat-1316443200.cos.ap-shanghai.myqcloud.com/public/logo.svg"></div></td></tr></tbody></table></td></tr><tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-size:24px; font-weight: 700;line-height:1;text-align:center;color:#000000;">悦问</div></td></tr><tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-size:14px;line-height:1;text-align:center;color:#77746E99;">验证码</div></td></tr><tr><td align="center" style="font-size:0px;padding:40px 55px;word-break:break-word;"><div style="font-size:24px;text-align:center;background: #e65c41;height:60px;line-height: 60px;font-weight: 700;cursor: pointer;"><p><span style="border-bottom:1px dashed #ccc;z-index:1;color: #ffffff" t="7" onclick="return false;">${usercodeinfo.randomNumbers}</span></p></div></td></tr><tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-size:14px;line-height:1;text-align:center;">访问 <a href="https://aiyin.chat" target="_blank" rel="noopener" style="color:#9B3D20;text-decoration: none;">https://aiyin.chat</a></div></td></tr></tbody></table></div></td></tr></tbody></table></div></div>`,
                subject: "悦问AI验证码"//主题
            }
            try {
